...
\markk{HOW TO YOU USE THE TOOL. REHASH A DEFINITION PBE (LANGUAGE OF THE EXAMLPLES IS JUST NORMAL HASKELL)}. The goal in natural synthesis is synthesize programs that meet a specification with the simplest and most readable code.
