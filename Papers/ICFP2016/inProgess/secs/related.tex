...
In contrast, our approach supports not only polymorphic first-order library functions, but also higher order functions from libraries - a key part of the functional programming expereince. 
