...
In this example, \ourTool/ returns the solution \codeinline{concatMap dupl} as the first solution after 5.26 seconds, it then continues searching and returns \codeinline{concatMap (replicate 2)} after 5.93 seconds.
...
The user only needs to express the basic data type as examples, and \ourTool/ can synthesize the \codeinline{solution} program.
\begin{lstlisting}
import Euterpea
