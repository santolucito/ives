...
For simplicity, imagine we only have the higher order functions \codeinline{map, filter, and fold} available.
\codeinline{map} will be assigned a refinement type that specifies the input and output lengths are equal.
