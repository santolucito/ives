...
\title{Natural Program Synthesis in Haskell}

\authorinfo{No Author given}
           { }
...
\terms
Programming by example, type-directed program synthesis, refinement types

\keywords
Haskell, synthesis, naturalness
